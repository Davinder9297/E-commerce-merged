...
const SideMenuSeller = ({ isOpen, onToggle }) => {
  return (
    ...
    >
      <div className="pl-4">
        <img src="../assests/icons/grocerify.svg" className="w-[196px]" alt=""/>
      </div>
      ...
      <div className="text-[#848484] font-Montserrat space-y-6 pl-2">
          ...
          >
            ...
            <span>
              <img
                ...
                className="w-full h-full relative" alt=""
              />
              <img
                src="../assests/icons/dashboard2.svg"
                className="w-[14px] absolute left-16 top-[145px]" alt=""
              />
            </span>
        ...
        <Link to={"/sellerorder"}>
          ...
          >
            {" "}
            <span>
              <img src="../assests/icons/order.svg" className="w-full h-full" alt=""/>
            </span>
