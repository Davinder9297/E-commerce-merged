...
router.route('/reqaddproduct').post(SellerAuth,productsController.reqaddproduct)
router.route('/toogleverifyreqaddproduct').post(AdminAuth,productsController.verifiyreqaddproduct)
router.route('/addstoreproducts').post(SellerController.verifySeller, SellerController.addstoreproducts)
router.route('/removestoreproducts').post(SellerController.verifySeller, SellerController.removestoreproducts)
router.route('/toogleproductvisibility').post(SellerController.verifySeller, SellerController.toogleproductvisibility)
...
//-- POST Shop
router.route('/addshop').post(SellerAuth, ShopController.registerShop)
router.route('/approveshop').post(AdminAuth,ShopController.approveshop)
router.route('/addstorevisit').post(ShopController.addvisit)
router.route('/acceptshoporder').post(SellerAuth, ShopController.acceptshoporder)
router.route('/cancelorder').post(Auth,ShopController.cancelOrder)
router.route('/cancelshoporder').post(SellerAuth,ShopController.cancelOrder)
router.route('/canceladminorder').post(AdminAuth,ShopController.cancelOrder)
// -- POST Seller
...
router.route('/approveseller').post(AdminAuth, SellerController.verifySeller,SellerController.approvSeller) // login in app with mobile
//-- POST Delivery Boy
router.route('/registerdeliveryboy').post(DeliveryBoyController.registerdeliveryboy)
router.route('/approvedeliveryboy').post(AdminAuth, DeliveryBoyController.verifyDeliveryboy,DeliveryBoyController.approvDeliveryboy) // login in app with mobile
...
router.route('/pickupdeliveryboyorder').post(DeliveryBoyController.pickupdeliveryboyorder) // login in app with mobile
// -- POST Review
router.route('/addreview').post(Auth, ReviewController.addReview) // login in app with mobile
...
router.route('/getordersgroupbyuser/:shopid').get(ordersController.getordersgroupbyuser) //getordersgroupbyuser
router.route('/getorderdetailsbyid/:order_id').get(ordersController.getOrderDetailsById) //get all orders
router.route('/getdeliveryorders').get(ordersController.getdeliveryorders) //get all orders
//-- GET Categories
...
router.route('/deliveryboys').get(AdminAuth,DeliveryBoyController.getdeliveryboys) // user with username
// -- GET Review
router.route('/reviews/:productId').get(ReviewController.getReviewsForProduct) // user with username
...
router.route('/updateuserbyadmin/:userID').put(AdminAuth, controller.updateUserByAdmin); // is use to update the user profile
router.route('/updateproduct/:productId').put(AdminAuth, productsController.updateProduct); // is use to update the user profile
router.route('/updateseller/:sellerId').put(AdminAuth, SellerController.updateSeller); // is use to update the user profile
router.route('/updatedeliveryboy/:deliveryboyID').put(AdminAuth, DeliveryBoyController.updatedeliveryboy); // is use to update the user profile
router.route('/updatecategory/:categoryID').put(AdminAuth, CategoriesController.updatecategory); // is use to update the user profile
...
router.route('/deleteproduct/productId').delete(AdminAuth, productsController.deleteProduct); // is use to remove user address
router.route('/deleteseller/sellerId').delete(AdminAuth, SellerController.deleteseller); // is use to remove user address
router.route('/deletedeliveryboy/:deliveryboyId').delete(AdminAuth, DeliveryBoyController.deletedeliveryboy); // is use to remove user address
router.route('/deletecategory/:categoryId').delete(AdminAuth, CategoriesController.deletecategory); // is use to remove user address
